...
public class AdminDao extends BaseDao {
	...
	public Admin login(Admin admin){
		String sql = "select * from o_admin where name=? and password=?";
		Admin adminRst = null;
		try {
	...
	public String changePassword(Admin admin,String newPassword){
		String sql = "select * from o_admin where id=? and password=?";
		...
		String sqlString = "update o_admin set password = ? where id = ?";
		try {
