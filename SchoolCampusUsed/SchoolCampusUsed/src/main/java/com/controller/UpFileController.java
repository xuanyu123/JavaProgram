...
public class UpFileController {
    ...
    @ResponseBody
    public void uploadFile(@RequestParam Map<String,String> map, @RequestParam("file") MultipartFile[] files, HttpServletRequest request) throws Exception {
        String goodsId = map.get("goodsId");
        //存储图片的物理路径
        String path = "/Users/xuanyu/JavaProgram/SchoolCampusUsed/SchoolCampusUsed/";
        String pic_path =path + "imgUpload/";
        ...
        for(MultipartFile file : files) {
            ...
            String fileUrl = "http://localhost:9090/imgUpload/" + newFileName;
