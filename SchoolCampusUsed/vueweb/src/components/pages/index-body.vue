    ...
    <el-row :gutter="20" style="margin-top: 30px;">
      <el-col :span="24">
        <el-row style="margin-top: 2px">
          <el-carousel direction="horizontal" :autoplay="true" height="470px">
            <el-carousel-item v-for="(v,k) in items" :key="k">
              <img :src="v" alt="请检查网络连接" width="100%" height="100%">
            </el-carousel-item>
          </el-carousel>
        </el-row>
    ...
    export default {
      ...
      methods:{
        ...
        addToShopCar(){
          ...
          $.ajax({
            type:"POST",
            url:"http://localhost:8083/shopCar/addOneToShopCar.do",
            dataType:"json",
