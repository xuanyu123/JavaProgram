        ...
        init(){
          ...
          $.get("http://localhost:8083/user/getInfo.do",jsonObj,function (data) {
            ...
            if(data.status === 1)
              ...
              self.formLabelAlign.status = "未启用";
