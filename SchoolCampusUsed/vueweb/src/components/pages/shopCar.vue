<template>
    <div>
      ...
      <el-dialog
        ...
        <div style="text-align: center">
          <h4>{{ dialogValue2 }}</h4>
          <img src="http://image.xuanyuwq.top//image/371604632450_.pic.jpg" alt="请检查网络连接" width="324" height="504">
          <br/>
          <span slot="footer" class="dialog-footer">
    ...
    export default {
        ...
        $.get("http://localhost:8083/shopCar/findAllByUid.do",jsonObj,function (data) {
          ...
          $(self.tableData).each(function (index,element) {
            ...
            $.get("http://localhost:8083/goods/getGoodsMainImg.do",jsonObj,function (data) {
              ...
              element.picture = "http://localhost:9090/imgUpload/" + data.imgUrl;
      ...
      methods: {
        ...
        handleEdit(index, row) {
          ...
          $.ajax({
            type:"POST",
            url:"http://localhost:8083/shopCar/deleteOneByUidAndGid.do",
            dataType:"json",
          ...
          $.ajax({
            ...
            success:function(data){
              if (data.code === 1) {
                $.ajax({
                  type:"POST",
                  url:"http://localhost:8083/orders/createOrder.do",
                  dataType:"json",
                  contentType:"application/json",
                  data: JSON.stringify(jsonObj),
                  success:function(data){
        ...
        buyAll() {
          ...
          $.ajax({
            type:"POST",
            url:"http://localhost:8083/orders/createOrders.do",
            dataType:"json",
            contentType:"application/json",
            data: JSON.stringify(jsonObj),
            success:function(data){
              if (data.code === 1) {
                $.ajax({
                  type:"POST",
                  url:"http://localhost:8083/shopCar/deleteAllByUid.do",
                  dataType:"json",
                  contentType:"application/json",
                  data: JSON.stringify(jsonObj),
                  success:function(data){
